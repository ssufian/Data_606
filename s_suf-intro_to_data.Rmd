...
cdc$wdiff <- with(cdc, cdc$wtdesire - cdc$weight)
class(cdc$wdiff)
head(cdc)
...
\clearpag  
  ...
  (a) wdiff class is integer
  
  (b) If Wdiff = 0, -> means they are at their ideal weight.  No need to go on diet
  
  (c) If Wdiff > 0, -> means they are Not at their ideal weight.  Need gain weight; eat more
  
  (d) If Wdiff < 0, -> means they are Not at their ideal weight.  Need lose weight; go on diet
...
# to check if distribution is normally distributed or Not?
hist(cdc$weight)
